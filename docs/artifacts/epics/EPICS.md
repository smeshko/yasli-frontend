...
This document tracks the implementation epics for **yasli-frontend**. Each epic is a
...
|---|------|--------|--------------|--------|
| 1 | [Institution detail page with map](./01-institution-detail-page.md) | 2 | backend epic 01, scraper epic 01 | Done |
| 2 | [Institution directory and availability](./02-institution-directory-and-availability.md) | 1 | Epic 01 | Ready for dev |
